//rcc_clock_init.c
//10.04.2018 настройка тактирования МК от HSI, HSЕ,
// переконфигурирование PLL в процессе работы, настройка GPIO в разных режимах.
//Для контроллеров STM32F030 серии.
...
//--------GPIO_Init---------------------------------
    ...
    //PA0, PA1 - вых без подтяжки (LED)(02.03.2017 - для платы индикатор угла на AS5045)
    ...
    //GPIOA->PUPDR |= GPIO_PUPDR_PUPDR0_1 | GPIO_PUPDR_PUPDR1_1 | GPIO_PUPDR_PUPDR2_1 | GPIO_PUPDR_PUPDR3_1;
	 ...
	 //PB1 - вых без подтяжки (LED)(02.03.2017 - для платы индикатор угла на AS5045)
	//GPIOB->MODER |= GPIO_MODER_MODER1_0;

	//PA4 - вх без подтяжки (BUTTON)
	//GPIOA->MODER &= ~GPIO_MODER_MODER4;
    //GPIOA->PUPDR |= GPIO_PUPDR_PUPDR9_0;

	//PA10 - вх UARTа (RxD - Input floating / Input pull-up)
	//GPIOA->MODER |= GPIO_MODER_MODER10_1;
	//GPIOA->AFR[1] |= (GPIO_AFRH_AFRH2 & 0x00000100);

	//PA9 - вых UARTа (TxD - Alternate function push-pull)
	//GPIOA->MODER |= GPIO_MODER_MODER9_1;
	//GPIOA->AFR[1] |= (GPIO_AFRH_AFRH1 & 0x00000010);//в рег альтерн функций (AFR[2]) для пина РА2 (GPIO_AFRL_AFRL2)выставить АФ-1 (0x00000100)
}
